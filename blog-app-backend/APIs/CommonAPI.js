...
commonApp.post("/users", upload.single("profileImageUrl"), async (req, res, next) => {
  ...
  try {
    ...
    console.log("Registration attempt:", { firstName, email, role });
    ...
    //create user object with only known fields
    const newUser = {
      firstName,
      lastName,
      email,
    ...
    //add CDN link of image if uploaded
    ...
    //send proper error response for duplicate email
    if (err.code === 11000) {
