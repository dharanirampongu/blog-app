...
export const cardClass =
  "bg-[#f5f3ff] rounded-2xl p-7 hover:bg-[#ede9fe] transition-colors duration-200 cursor-pointer";
...
export const linkClass = "text-[#7c3aed] hover:text-[#6d28d9] transition-colors";

// ─── Buttons ──────────────────────────────────────────
export const primaryBtn =
  "bg-[#7c3aed] text-white font-semibold px-5 py-2 rounded-full hover:bg-[#6d28d9] transition-colors cursor-pointer text-sm tracking-tight";
export const secondaryBtn =
  "border border-[#ddd6fe] text-[#1d1d1f] font-medium px-5 py-2 rounded-full hover:bg-[#f5f3ff] transition-colors cursor-pointer text-sm";
export const ghostBtn = "text-[#7c3aed] font-medium hover:text-[#6d28d9] transition-colors cursor-pointer text-sm";

// ─── Forms ────────────────────────────────────────────
export const formCard = "bg-[#f5f3ff] rounded-2xl p-10 max-w-4xl mx-auto";
...
export const inputClass =
  "w-full bg-white border border-[#ddd6fe] rounded-xl px-4 py-2.5 text-[#1d1d1f] text-sm placeholder:text-[#a1a1a6] focus:outline-none focus:border-[#7c3aed] focus:ring-2 focus:ring-[#7c3aed]/10 transition";
export const formGroup = "mb-4";
export const submitBtn =
  "w-full bg-[#7c3aed] text-white font-semibold py-2.5 rounded-full hover:bg-[#6d28d9] transition-colors cursor-pointer mt-2 text-sm tracking-tight";

// ─── Navbar ───────────────────────────────────────────
export const navbarClass =
  "bg-white/85 backdrop-blur-xl backdrop-saturate-150 border-b border-[#ddd6fe] px-8 h-[52px] flex items-center sticky top-0 z-50";
...
export const navLinkActiveClass = "text-[0.8rem] text-[#7c3aed] font-medium";
...
export const articleCardClass =
  "bg-[#f5f3ff] p-7 hover:bg-[#ede9fe] transition-colors duration-200 flex flex-col gap-2.5 cursor-pointer";
...
export const tagClass = "text-[0.65rem] font-semibold text-[#8b5cf6] uppercase tracking-widest w-fit";
...
export const articleCategory = "text-[0.7rem] font-semibold uppercase tracking-widest text-[#a855f7]";

export const articleMainTitle = "text-4xl font-bold text-[#1d1d1f] leading-tight tracking-tight";

export const articleAuthorRow =
  "flex items-center justify-between border-t border-b border-[#ddd6fe] py-4 text-sm text-[#6e6e73]";
...
export const articleFooter = "border-t border-[#ddd6fe] mt-12 pt-6 text-sm text-[#a1a1a6]";
// ─── Article Actions ─────────────────────────────
export const articleActions = "flex gap-3 mt-6";

export const editBtn = "bg-[#7c3aed] text-white text-sm px-4 py-2 rounded-full hover:bg-[#6d28d9] transition";
...
export const articleStatusActive =
  "absolute top-3 right-3 text-[10px] font-semibold px-2 py-1 rounded-full bg-[#f43f5e]/20 text-[#be123c]";
...
export const successClass =
  "bg-[#f43f5e]/[0.07] text-[#9f1239] border border-[#f43f5e]/20 rounded-xl px-4 py-3 text-sm";
export const loadingClass = "text-[#7c3aed]/60 text-sm animate-pulse text-center py-10";
export const emptyStateClass = "text-center text-[#a1a1a6] py-16 text-sm";

// ─── Comments ───────────────────────────────────────
export const commentsWrapper = "mt-12 flex flex-col gap-6";

export const commentCard = "bg-[#f5f3ff] rounded-2xl p-5 transition hover:bg-[#ede9fe]";
...
export const avatar =
  "w-9 h-9 rounded-full bg-[#7c3aed]/10 text-[#7c3aed] flex items-center justify-center text-sm font-semibold";

export const commentUserRow = "flex items-center gap-3";

// ─── Divider ──────────────────────────────────────────
export const divider = "border-t border-[#ddd6fe] my-10";